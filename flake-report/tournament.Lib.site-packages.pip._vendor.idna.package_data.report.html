...
<html>
   <head>
      <title>flake8 violations: tournament\Lib\site-packages\pip\_vendor\idna\package_data.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="tournament.Lib.site-packages.pip._vendor.idna.package_data.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               tournament\Lib\site-packages\pip\_vendor\idna\package_data.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="tournament.Lib.site-packages.pip._vendor.idna.package_data.source.html#l2">
                  <tt><i>2</i> &nbsp;</tt>
               </a>
            </li>
            </ul>
